...
const CaseSchema = new Schema(
  {
    ...
    // Which analyst (or admin) is working this case — replaces the
    // frontend's "local only" mock dropdown, which had no real backend
    // behind it (POST /:id/assign never existed, hence the 404).
